...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        print(gms)
            ...
            #tt = tt.reset_index(level=['season'])
            #tt.columns = ['season','other']
            #tt2 = pd.DataFrame(tt.other.tolist(),columns=['lcl','mean','ucl'])
            #tt2['season'] = tt['season']
            #tt2['species'] = [cname] * tt2.shape[0]